...
///___ TIRAGE DES TEMPS DE DIVERGENCE ___///
        ...
        // A faire : vector<string> nodeTemps ; // Table de correspondance nom du node/temps de divergence
...
///___ BOUCLE EVOLUTIVE ___///
        ...
        for (int t = tempsMax; t > 0; t--) // La boucle d'évolution est Foreward, avec t commençant à tempsMax et terminant à 0
        {
            ...
            // Emprunt (Note: Gérer les emprunts globaux avec des pointeurs, et réfléchir à l'impact de l'ordre d'emprunt pour les nodes)
/*
            // Emprunts locaux
            if (t == temps[1] - 1)
            {
